...
function showResultBox(score) {
    ...
    if (userScore < 12) {
        let scoreTag = '<span>You are not selected as you scored<p>' + score + '</p>out of <p>' + questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else if (userScore >= 12 ) {
        let scoreTag = ' <span> Congratulations your final score is<p>'+ score + '</p>out of <p>' + questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else {
